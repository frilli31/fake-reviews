...
final instructions = [
  ...
  Instruction(
      text: 'Ora dovrai ora immaginare di acquistare dei prodotti o dei servizi.\n\nIl tuo compito sarà quello di recensire ciascuno dei prodotti e servizi acquistati.',
      image: 'instruction_2.png'
  ),
  Instruction(
      text:   'In alcuni casi la situazione d’acquisto ti chiederà di valutare il prodotto/servizio soltanto sulla base della sua qualità.\n\nIn altri casi dovrai invece tenere conto anche di altri elementi, che potranno influenzare in positivo o in negativo la tua recensione, spingendoti a fornire una valutazione non genuina del prodotto/servizio.',
      image: 'instruction_3.png'
  ),
  Instruction(
      text:   'Valuta il prodotto/servizio su una scala da 1 (per niente soddisfatto) a 5 (pienamente soddisfatto), tenendo conto di tutti gli elementi che possono influenzare la tua valutazione.',
      image: 'instruction_4.png'
  ),
  Instruction(
      text:   'Per effettuare la recensione fai tap sulla stella più a sinistra e, tenendo premuto, trascina fino alla valutazione desiderata.\n\nOra ti verranno mostrati alcuni esempi in modo da mostrarti come avviene la votazione.',
